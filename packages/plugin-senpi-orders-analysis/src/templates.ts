...
- The response always has a intro.
    ...
    - If the user request is analysis type 2, then ALWAYS use this as an intro "These outcomes reflect your copy trading performance, not the direct results of the groups themselves."
