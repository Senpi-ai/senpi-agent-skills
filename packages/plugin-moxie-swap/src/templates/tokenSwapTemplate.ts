...
3. Validate required fields:
   ...
   - stopLoss: If the user specifies a stop loss along with a buy, extract the stop loss percentage and include it in the stopLoss object. The stop loss percentage must be a positive number greater than 0. If the percentage is 0 or negative, return an error with a prompt message: "Stop loss percentage must be greater than 0."
