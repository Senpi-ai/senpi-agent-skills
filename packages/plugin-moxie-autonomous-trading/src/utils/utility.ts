...
const errorMessages: Record<string, string> = {
    ...
    AERR066: "Invalid input: duration is required and must be greater than 0 for multiple users",
    AERR067: "Invalid input: duration is required and must be greater than 0 for multiple users",
    AERR201:
